...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            'Uses actions (list, create, retireve, update, partial_update and destroy)',
            'Automaticallly maps to URLs user Routers',
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    """Handles creating, reading and update the profile feed items."""
    authentication_classes = (TokenAuthentication,)
